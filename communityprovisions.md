...
The server or system listens to and tracks for the the time the user and their intended other users wants to what the user hears which is what the user and their intended other users wants when and while the user says or thinks the server or system is listening for what we want except for what is asked with the Info Gesture and Ask… System Commands and is independent of other listening by the server and other times the phrase is or was said or thought by the user until the user says or thinks the server or server isn’t listening or the server or system isn’t listening for what we want, by default the server or system listens for what the owners of the system and their significant others want if the owner of the system has one or more significant others which the owner of the system would want to have the opinion of considered in system use individually and respectively per owner as well as each user, with a mustn’t be what the owners of the system and their significant others don’t want individually and respectively per owner and then can also be what the users want individually and respectively
