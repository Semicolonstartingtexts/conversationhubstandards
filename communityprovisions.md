...
The server listens to and tracks for the right amount of time what the user hears which is best for users which matter to the user which matters to the users when and while the user says or thinks the server or system is listening for what’s best for those who matter to me which matters to me and them until the user says or thinks the server or server isn’t listening or the server or system isn’t listening for what’s best
