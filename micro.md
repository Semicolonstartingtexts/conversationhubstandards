...
Spec To:
… Define and set and/or clear all the necessary preferrings and definitions of the systems for the user to accomplish a particular goal when I think or say a phrase referencing an objective and end the phrase with … spec and confirm, set and confirm
