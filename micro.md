Repeat for each title below the phrase “the referencing endpoint or waypoint does…” followed by what’s under the title picking up after the ellipsis…
...
Info Gesture: 
… When I touch my thumb tip to the tip of my pinky and ask a question I receive information from the nanotech using the nanotech and my own memories and the connected resources to my nanotech’s predictive information about the query by noticing the response, confirmed as a rule
...
… the referencing endpoint or waypoint may only be referenced by the owner, managing entity or still approved entity to reference the referencing endpoint or waypoint of the Approved Use And Referencing titled rule in the referenced micro.md file