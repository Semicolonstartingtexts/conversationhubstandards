...
Info Gesture: 
… When I touch my thumb tip to the tip of my pinky and ask a question I receive information from the nearest endpoint and/or waypoint in the inheritance chain using the nearest endpoint and/or waypoint in the inheritance chain and the connected resources to the nearest endpoint and/or waypoint in the inheritance chain’s predictive information about the query by noticing the response, confirmed as a rule
