...
… Clears the representation of the referenced system speech on, referring to or by or made through the referenced object, which isn’t the Conversation Server Standards repository, device when I think or say “Clear” or “Lose”, “system speech” and a reference to an object, device or entity, if there isn’t a referenced object, the referenced object is the device itself and end the phrase with “and confirm,” set and confirm
