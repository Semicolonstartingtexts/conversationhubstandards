...
Messaging:
… When thinking the phrases “send a message to…”, “replay the last message…”, or “reply with…”, if thought by me or in response to one of my messages does the following things when I think those specific phrases, the default messaging confirmation is “Send and confirm”
...
… performs system commands when given and confirms the most recently said or now by my own self what I want as long as I do still want the system to do what I said I wanted most recently or now when I say or think, or whichever is specified as to which is listened to by the system, what I want to do except for to what I ask the Info Gesture System Command while the system is said or thought to be listening and is listening by default without implying the opposite when the system is said or thought as isn’t listening, but rather, waiting on me giving my preferrings, system commands and definitions of the system
