...
Spec To:
… Define and set all the best and most authentic and natural for the user of preferrings and definitions of the systems for the user to accomplish a particular goal when I think or say a phrase referencing an objective and end the phrase with … spec and confirm, set and confirm
