...
The servers and the relays and shared lobbies of joined nodes, called rooms, have a limit of 10 users per server or room, and the nodes have a limit of 18 users per node
