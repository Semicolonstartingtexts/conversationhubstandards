...
Server Provisions, the set of provisions that outlines a way all users of a server may interact with the server, the rest of the provisions of the server aren’t allowed priority over the Conversation Server Standards and the definition of the endpoint, waypoint, server, extension, relay, node, whichever is the most relevant to the provision, and the provisions of the Conversations Server Standards aren’t permitted to be unstacked in less than entirety or altered and aren’t permitted to be opted out of or opted in to except in entirety, as well as system speech can’t be stacked, applied or confirmed about the Conversation Server Standards except opt-in, opt-out preferences, as well as use of the provisions therein
