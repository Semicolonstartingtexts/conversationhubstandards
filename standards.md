...
Server Provisions, the set of provisions that outlines a way all users of a server may interact with the server, the rest of the provisions of the server aren’t allowed priority over the Semicolonstartingtexts/conversationserverstandards GitHub.com repository’s main branch’s standards.md and communityprovisions.md files’ contents, without expansion, alteration or redaction, most recently approved version by the owner or administrator of the endpoint or waypoint the server is on of at least v0.2a4, and the definition of the endpoint, waypoint, server, relay, node, whichever is the most relevant to the provision, and the provisions of the Semicolonstartingtexts/conversationserverstandards GitHub.com repository’s main branch’s standards.md and communityprovisions.md files’ contents, without expansion, alteration or redaction, most recently approved version by the owner or administrator of the endpoint or waypoint the server is on of at least version v0.2a4, aren’t permitted to be unstacked in less than entirety or for an endpoint or waypoint to be pointed to by or stacked with a server with the provisions of Semicolonstartingtexts/conversationserverstandards GitHub.com repository’s main branch’s standards.md and communityprovisions.md files’ contents, without expansion, alteration or redaction, most recently approved version by the owner or administrator of the endpoint or waypoint the server is on of at least v0.2a4, and aren’t permitted to be opted out of or opted in to except in entirety, as well as system speech can’t be stacked, applied or confirmed about the Conversation Server Standards except opt-in, opt-out preferencings, And as well as use of the provisions therein
