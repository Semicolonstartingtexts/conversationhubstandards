...
Joining, the linking of endpoints and relays of endpoints as a sharing of a shared lobby, and to be taken to the zones or lobbies of a server on a joined endpoint or relay of an endpoint, the server definition must allow or at least mustn’t have a restriction against the criteria the user matches
