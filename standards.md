...
Relay, an object imbued with the functionality of endpoint, the imbuing is tracked by the endpoint the relay was imbued on, keeping the owner of the endpoint of where the object was imbued, but assigning an owner of the relay to the user which does the imbuing
