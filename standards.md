...
Spec... stacks the user or referenced user or mapping which the provisions permit or system or device on the best and most natural and authentic for the user, and/or untracks the tracking and tracked of then, if stacking or stacked on of, unstacks the user, users, system, systems, device, devices, mapping, mappings, of all the maladaptive or impeding or both, system speech the user is authorized to to achieve the objective or objectives mentioned or referenced on the phrase, if starting a system command, or alternatively, ending a phrase with the phrase spec and the initial confirmation
